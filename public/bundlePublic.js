...
var css = "@import url(assets/fonts/fontawesome.css);@import url(\"https://fonts.googleapis.com/css?family=Open+Sans:400,700&display=swap&subset=cyrillic,cyrillic-ext\");*{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box}*:before,*:after{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box}h1,h2,h3,h4,ul,ol,div,span,figure{margin:0;padding:0}ul,ol{list-style:none}a{text-decoration:none}body{width:100%;height:100vh;padding:0;margin:0;overflow:hidden;margin:0 auto;font-family:'Open Sans', sans-serif;font-weight:normal;background-size:cover;position:fixed;z-index:0;display:flex;flex-direction:column;justify-content:center;align-items:center;scroll-behavior:smooth}.mainWindow{width:1920px;height:1080px;overflow:hidden;background:url(\"./assets/grunge_BG.png\") center no-repeat;background-size:cover}.header{width:100%;background-color:transparent;z-index:1000;color:#fff;position:fixed;height:300px}.header>.headerLine{display:flex;flex-direction:row;justify-content:space-between;align-items:center;background-color:#250506;width:100%;height:65px;padding:0 20px;margin-bottom:-3px}.header>.headerLine>.leftModule>i{font-size:120px;padding:0 10px}.header>.headerLine>.rightModule>i{font-size:36px;padding:0 10px}.header>.headerLine>.rightModule>.currentTime{font-size:36px;padding:0 20px}.header>.title{height:120px;width:100%;background:linear-gradient(0deg, #250506, #250506 55%, #520d0f 100%);display:flex;justify-content:center;align-items:center;font-weight:bold;font-size:50px;color:#fff}.msgWindow{z-index:0;width:100%;scroll-behavior:smooth;padding:0px 100px;transition:transform 300ms;bottom:0;transform:translate(0px, 1000px)}.msgWindow>article{display:flex;flex-direction:row;align-items:center;padding:10px auto;margin:10px 0}.msgWindow>article>.userIcon{width:200px;height:200px;background-color:#c52429;background-size:auto 100%;border-radius:20px;box-shadow:5px 5px 5px 0 rgba(0,0,0,0.2);display:flex;justify-content:center;align-items:center;font-size:100px}.msgWindow>article>.userPlace{width:200px}.msgWindow>article>div{border-radius:0 20px 20px 20px;margin:0 20px;background-color:#250506;padding:0 20px;font-size:50px;box-shadow:5px 5px 5px 0 rgba(0,0,0,0.2)}.msgWindow>article>div>.userName{font-weight:bold;color:#c52429}.msgWindow>article>div>.userMsg{color:#fff}.msgWindow>.systemMessage{background-color:#250506;color:#fff;border-radius:20px;display:flex;justify-content:center;align-items:center;height:70px;margin:10px 100px;font-size:40px}.sendMsgWindow{padding:0 20px;width:100%;height:100px;background-color:#250506;bottom:0;position:absolute;display:flex;align-items:center;justify-content:space-between;color:#c52429}.sendMsgWindow>i{font-size:50px;margin:0 10px}.sendMsgWindow>input{color:#fff;width:100%;margin:0 10px;font-size:50px;border:2px solid #c52429;border-radius:50px;padding:0 30px;background-color:#c52429}.Shark{background:url(\"assets/users/user_shark.png\") center no-repeat;background-size:auto 100%}.Mouse{background:url(\"assets/users/user_mouse.png\") center no-repeat;background-size:auto 100%}.Gorbunov{background:url(\"assets/users/user_gorbunov.jpg\") center no-repeat;background-size:auto 100%}.yanukovich{background:url(\"assets/users/user_yanukovich.jpg\") center no-repeat;background-size:auto 100%}.angry{width:200px;height:200px;background:url(\"assets/smiles/angry.png\") center no-repeat;background-size:150px 150px}.smirkface{width:200px;height:200px;background:url(\"assets/smiles/smirkface.png\") center no-repeat;background-size:150px 150px}.hmmface{width:200px;height:200px;background:url(\"assets/smiles/hmmface.png\") center no-repeat;background-size:150px 150px}.waving{width:200px;height:200px;background:url(\"assets/n2/waving.png\") center no-repeat;background-size:150px 150px}.champagne{width:200px;height:200px;background:url(\"assets/n2/champagne.png\") center no-repeat;background-size:150px 150px}.dance{width:200px;height:200px;background:url(\"assets/n2/dance.png\") center no-repeat;background-size:150px 150px}.flag{width:200px;height:200px;background:url(\"assets/n2/flag.png\") center no-repeat;background-size:150px 150px}.norma_meme{width:200px;height:200px;background:url(\"assets/n2/norma_meme.png\") center no-repeat;background-size:270px 200px}.sad{width:200px;height:200px;background:url(\"assets/n2/sad.png\") center no-repeat;background-size:150px 150px}.sad_2{width:200px;height:200px;background:url(\"assets/n2/sad_2.png\") center no-repeat;background-size:150px 150px}.impossible_meme{width:200px;height:200px;background:url(\"assets/n2/impossible_meme.png\") center no-repeat;background-size:344px 200px}\n"
